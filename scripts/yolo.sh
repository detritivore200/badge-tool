...
PR_URL=$(gh pr create --title "YOLO PR $TS" --body "YOLO update for badge-tool")
gh pr merge "$PR_URL" --merge --admin
echo "Success! Checked your profile for YOLO: https://github.com/detritivore200?tab=achievements"
