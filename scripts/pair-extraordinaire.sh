...
PR_URL=$(gh pr create --title "Pair PR $TS" --body "Pair Extraordinaire via badge-tool")
gh pr merge "$PR_URL" --merge --admin
echo "Success! Checked your profile for Pair Extraordinaire: https://github.com/detritivore200?tab=achievements"
